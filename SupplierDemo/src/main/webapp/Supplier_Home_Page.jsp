...
<body>
 ...
 <!Header>
    ...
    <div class="header">
        ...
        <a href="http://localhost:8099/SupplierDemo/supplierInsert.jsp">Create New Supplier Account</a>
        <a href="http://localhost:8099/SupplierDemo/login.jsp">Login</a>
     </div>
...
<br/> 
      ...
      <h3 id="header"> Welcome! Suppliers </h3>
