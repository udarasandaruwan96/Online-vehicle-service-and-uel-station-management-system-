...
<body>
 ...
 <!Header>
    ...
    <div class="header">
        ...
        <a href="http://localhost:8099/Machanic_Mangment/Machanic_Insert.jsp">Create New Machanic Engineers Account</a>
        <a href="http://localhost:8099/Machanic_Mangment/Login.jsp">Login</a>
     </div>
...
<br/> 
      ...
      <h2 id="header"> Welcome!  Machanic Engineers </h2>
	...
	<form action="insert" method="post">
		...
		<input type="submit" name="submit" value="Register Machanic">
	</form>
